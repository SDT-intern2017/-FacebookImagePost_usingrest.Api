...
public class DuplicateImageFinder {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage one = ImageIO.read(new File("E:/prajeesh/Facebook///FB_IMG_1475557588735 - Copy.jpg"));
        BufferedImage two = ImageIO.read(new File("E:/prajeesh/Facebook/FB_IMG_1475557588735.jpg"));
